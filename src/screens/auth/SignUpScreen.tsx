...
import { View, Text, TextInput, TouchableOpacity, StyleSheet, SafeAreaView, ActivityIndicator, Platform, ScrollView } from 'react-native';
...
export const SignUpScreen = ({ route, navigation }: any) => {
  ...
  const handleSignUp = async () => {
    ...
    setIsLoading(true);
    try {
      // Map phone to dummy email for Firebase Auth
      ...
      // 2. Save User Profile to Firestore (collection: users)
      ...
      // Success! AppNavigator will handle routing
    } catch (error: any) {
